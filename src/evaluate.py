...
##补充画图代码
    ...
    aucs['average'] = np.array(list(aucs.values())).mean()
    ...
    plt.title('AUC Scores for Each Diagnosis')
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    for diagnosis, auc_score in aucs.items():
        plt.text(diagnosis, auc_score, f'{auc_score:.3f}', ha='center', va='bottom')

    #plt.show()
    plt.savefig('C:/Users/30961/Desktop/test/newtest/django/mysite/checkstatic/static/image/auc.jpg')
